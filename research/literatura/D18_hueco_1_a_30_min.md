...
| **Brogaard, Hendershott y Riordan 2014**, *RFS* — **YA NO ES DE MEMORIA: leído por Roberto, textual en `L14`** | *"trading in the direction of permanent price changes and in the opposite direction of transitory pricing errors… through their liquidity demanding orders… The direction of HFTs' trading predicts price changes over short horizons measured in seconds"* | que lo que hubiera en la franja de segundos **lo consume el escalón 1**: ahora con texto. NASDAQ 2008-2009: por `F13` no es evidencia sobre el ES; es el mecanismo |
