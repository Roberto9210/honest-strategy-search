...
|---|---|---|---|---|---|
| **L01** | última media hora de la sesión de contado | **15:30 – 16:00** | ES | **PICO de la tarde** | Baltussen implica ~25 pb para esta media hora contra 12,1 del escalado uniforme: **factor 2,07** medido por su propio paper |
